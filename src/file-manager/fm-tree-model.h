...
typedef struct {
  ...
  void (*row_loaded)(FMTreeModel *tree_model, GtkTreeIter *iter);
} FMTreeModelClass;
...
void fm_tree_model_add_root_uri(FMTreeModel *model, const char *root_uri,
                                ...
                                GMount *mount);
void fm_tree_model_remove_root_uri(FMTreeModel *model, const char *root_uri);
...
gboolean fm_tree_model_file_get_iter(FMTreeModel *model, GtkTreeIter *iter,
                                     CajaFile *file, GtkTreeIter *currentIter);

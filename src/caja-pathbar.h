...
#define CAJA_PATH_BAR(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), CAJA_TYPE_PATH_BAR, CajaPathBar))
#define CAJA_PATH_BAR_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), CAJA_TYPE_PATH_BAR, CajaPathBarClass))
#define CAJA_IS_PATH_BAR(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), CAJA_TYPE_PATH_BAR))
#define CAJA_IS_PATH_BAR_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), CAJA_TYPE_PATH_BAR))
#define CAJA_PATH_BAR_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj), CAJA_TYPE_PATH_BAR, CajaPathBarClass))
...
struct _CajaPathBarClass {
  ...
  void (*path_clicked)(CajaPathBar *path_bar, GFile *location);

  void (*path_event)(CajaPathBar *path_bar, GdkEventButton *event,
                     GFile *location);
};

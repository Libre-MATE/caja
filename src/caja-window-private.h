...
#define CAJA_MENU_PATH_ZOOM_OUT_ITEM \
  "/menu/View/Zoom Items Placeholder/Zoom Out"
#define CAJA_MENU_PATH_ZOOM_NORMAL_ITEM \
  "/menu/View/Zoom Items Placeholder/Zoom Normal"
 ...
 * completely unusable. However, if all the extra bits (sidebar, location bar,
 * etc) are turned off, you can see an icon or two at this size. See bug 5946.
 */
...
void caja_window_set_status(CajaWindow *window, CajaWindowSlot *slot,
                            const char *status);
...
void caja_window_set_active_slot(CajaWindow *window, CajaWindowSlot *slot);
...
void caja_navigation_window_remove_bookmarks_menu_callback(
    CajaNavigationWindow *window);

void caja_navigation_window_remove_bookmarks_menu_items(
    CajaNavigationWindow *window);
...
void caja_navigation_window_load_extension_toolbar_items(
    CajaNavigationWindow *window);

...
#define CAJA_MENU_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), CAJA_TYPE_MENU, CajaMenuClass))
...
#define CAJA_MENU_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), CAJA_TYPE_MENU, CajaMenuClass))
/* CajaMenuItem defines */
#define CAJA_TYPE_MENU_ITEM (caja_menu_item_get_type())
#define CAJA_MENU_ITEM(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), CAJA_TYPE_MENU_ITEM, CajaMenuItem))
#define CAJA_MENU_ITEM_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), CAJA_TYPE_MENU_ITEM, CajaMenuItemClass))
#define CAJA_MENU_IS_ITEM(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), CAJA_TYPE_MENU_ITEM))
#define CAJA_MENU_IS_ITEM_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((obj), CAJA_TYPE_MENU_ITEM))
#define CAJA_MENU_ITEM_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj), CAJA_TYPE_MENU_ITEM, CajaMenuItemClass))

...
#define CAJA_FILE_INFO(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), CAJA_TYPE_FILE_INFO, CajaFileInfo))
#define CAJA_IS_FILE_INFO(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), CAJA_TYPE_FILE_INFO))
#define CAJA_FILE_INFO_GET_IFACE(obj) \
  (G_TYPE_INSTANCE_GET_INTERFACE((obj), CAJA_TYPE_FILE_INFO, CajaFileInfoIface))
 ...
 * @invalidate_extension_info: Invalidates information of the file provided by
 * extensions. See caja_file_info_invalidate_extension_info() for details.
...
struct _CajaFileInfoIface {
  ...
  gboolean (*is_mime_type)(CajaFileInfo *file, const char *mime_Type);
  gboolean (*is_directory)(CajaFileInfo *file);

  void (*add_emblem)(CajaFileInfo *file, const char *emblem_name);
  char *(*get_string_attribute)(CajaFileInfo *file, const char *attribute_name);

...
#define EEL_EDITABLE_LABEL_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), EEL_TYPE_EDITABLE_LABEL, \
                           EelEditableLabelClass))
...
#define EEL_EDITABLE_LABEL_GET_CLASS(obj)                    \
  (G_TYPE_INSTANCE_GET_CLASS((obj), EEL_TYPE_EDITABLE_LABEL, \
                             EelEditableLabelClass))
...
struct _EelEditableLabelClass {
  ...
  void (*move_cursor)(EelEditableLabel *label, GtkMovementStep step, gint count,
                      gboolean extend_selection);
  void (*insert_at_cursor)(EelEditableLabel *label, const gchar *str);
  void (*delete_from_cursor)(EelEditableLabel *label, GtkDeleteType type,
                             gint count);
  ...
  void (*populate_popup)(EelEditableLabel *label, GtkMenu *menu);
};

GType eel_editable_label_get_type(void) G_GNUC_CONST;
GtkWidget *eel_editable_label_new(const char *str);
void eel_editable_label_set_text(EelEditableLabel *label, const char *str);

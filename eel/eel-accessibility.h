...
#define EEL_IS_ACCESSIBLE_TEXT(obj) \
  G_TYPE_CHECK_INSTANCE_TYPE((obj), EEL_TYPE_ACCESSIBLE_TEXT)
#define EEL_ACCESSIBLE_TEXT(obj) \
  G_TYPE_CHECK_INSTANCE_CAST((obj), EEL_TYPE_ACCESSIBLE_TEXT, EelAccessibleText)
#define EEL_ACCESSIBLE_TEXT_GET_IFACE(obj)                        \
  (G_TYPE_INSTANCE_GET_INTERFACE((obj), EEL_TYPE_ACCESSIBLE_TEXT, \
...
#define EEL_ACCESSIBLE_FACTORY(type, factory_name, type_as_function,         \
                               opt_create_accessible)                        \
                                                                             \
  static GType type_as_function##_factory_get_accessible_type(void) {        \
    return type;                                                             \
  }                                                                          \
                                                                             \
  static AtkObject *type_as_function##_factory_create_accessible(            \
      GObject *obj) {                                                        \
  ...
  static void type_as_function##_factory_class_init(                         \
    ...
    klass->get_accessible_type =                                             \
        type_as_function##_factory_get_accessible_type;                      \
  }                                                                          \
                                                                             \
  static GType type_as_function##_factory_get_type(void) {                   \
    static GType t = 0;                                                      \
                                                                             \
    if (!t) {                                                                \
      static const GTypeInfo tinfo = {                                       \
          ...
          NULL};                                                             \
                                                                             \
      t = g_type_register_static(ATK_TYPE_OBJECT_FACTORY, factory_name,      \
                                 &tinfo, 0);                                 \
    }                                                                        \
                                                                             \
    return t;                                                                \
...
#define EEL_OBJECT_SET_FACTORY(object_type, type_as_function)            \
  atk_registry_set_factory_type(atk_get_default_registry(), object_type, \

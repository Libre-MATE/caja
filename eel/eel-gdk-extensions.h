...
#define EEL_RGBA_COLOR_PACK(r, g, b, a)                                \
  ((((guint32)a) << 24) | (((guint32)r) << 16) | (((guint32)g) << 8) | \
   (((guint32)b) << 0))

/* Pack opaque RGBA values into 32 bits */
#define EEL_RGB_COLOR_PACK(r, g, b) EEL_RGBA_COLOR_PACK((r), (g), (b), 0xFF)
...
/* A gradient spec. is a string that contains a specifier for either a
   ...
   The gradient is vertical by default and the spec. can end with ":v" to
...
/* A version of parse_color that substitutes a default color instead of
   returning a boolean to indicate it cannot be parsed.
*/

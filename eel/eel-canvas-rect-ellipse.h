 ...
 * ------------------------------------------------------------------------------------------
 * x1			double		RW		Leftmost coordinate of
 *rectangle or ellipse
 * y1			double		RW		Topmost coordinate of
 *rectangle or ellipse
 * x2			double		RW		Rightmost coordinate of
 *rectangle or ellipse
 * y2			double		RW		Bottommost coordinate of
 *rectangle or ellipse
 * fill_color		string		W		X color specification
 *for fill color, or NULL pointer for no color (transparent) fill_color_gdk
 *GdkColor*	RW		Allocated GdkColor for fill outline_color
 *string		W		X color specification for outline color,
 *							or NULL pointer for no color
 *(transparent) outline_color_gdk	GdkColor*	RW
 *Allocated GdkColor for outline fill_stipple		GdkBitmap*	RW
 *Stipple pattern for fill outline_stipple	GdkBitmap*	RW
 *Stipple pattern for outline
 * width_pixels		uint		RW		Width of the outline in
 *pixels.  The outline will not be scaled when the canvas zoom factor is
 *changed.
 * width_units		double		RW		Width of the outline in
 *canvas units.  The outline will be scaled when the canvas zoom factor is
 *changed.
 */
...
struct _EelCanvasRE {
  ...
  unsigned int
      width_pixels : 1; /* Is outline width specified in pixels or units? */
};

...
G_DEFINE_TYPE(CajaKeepLastVerticalBox, caja_keep_last_vertical_box,
              GTK_TYPE_BOX)

/* Standard class initialization function */
static void caja_keep_last_vertical_box_class_init(
    CajaKeepLastVerticalBoxClass *klass) {
...
GtkWidget *caja_keep_last_vertical_box_new(gint spacing) {
  ...
  box = CAJA_KEEP_LAST_VERTICAL_BOX(
      gtk_widget_new(caja_keep_last_vertical_box_get_type(), NULL));
...
static void caja_keep_last_vertical_box_size_allocate(
  ...
  GTK_WIDGET_CLASS(caja_keep_last_vertical_box_parent_class)

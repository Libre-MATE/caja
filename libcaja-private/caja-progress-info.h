...
#define CAJA_PROGRESS_INFO(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), CAJA_TYPE_PROGRESS_INFO, CajaProgressInfo))
#define CAJA_PROGRESS_INFO_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), CAJA_TYPE_PROGRESS_INFO, CajaProgressInfoClass))
#define CAJA_IS_PROGRESS_INFO(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), CAJA_TYPE_PROGRESS_INFO))
#define CAJA_IS_PROGRESS_INFO_CLASS(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), CAJA_TYPE_PROGRESS_INFO))
#define CAJA_PROGRESS_INFO_GET_CLASS(o)                    \
  (G_TYPE_INSTANCE_GET_CLASS((o), CAJA_TYPE_PROGRESS_INFO, \
                             CajaProgressInfoClass))
...
/* Signals:
   ...
   "progress-changed" - the percentage progress changed (or we pulsed if in
   activity_mode "started" - emited on job start "finished" - emitted when job
   is done

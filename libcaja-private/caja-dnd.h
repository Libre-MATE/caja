...
#define CAJA_ICON_DND_XDNDDIRECTSAVE_TYPE \
...
typedef void (*CajaDragEachSelectedItemDataGet)(const char *url, int x, int y,
                                                int w, int h, gpointer data);
typedef void (*CajaDragEachSelectedItemIterator)(
    CajaDragEachSelectedItemDataGet iteratee, gpointer iterator_context,
    gpointer data);
...
int caja_drag_modifier_based_action(int default_action, int non_default_action);

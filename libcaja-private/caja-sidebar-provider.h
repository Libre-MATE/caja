...
#define CAJA_SIDEBAR_PROVIDER(obj)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), CAJA_TYPE_SIDEBAR_PROVIDER, \
                              CajaSidebarProvider))
#define CAJA_IS_SIDEBAR_PROVIDER(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), CAJA_TYPE_SIDEBAR_PROVIDER))
#define CAJA_SIDEBAR_PROVIDER_GET_IFACE(obj)                        \
  (G_TYPE_INSTANCE_GET_INTERFACE((obj), CAJA_TYPE_SIDEBAR_PROVIDER, \
                                 CajaSidebarProviderIface))
...
struct _CajaSidebarProviderIface {
  ...
  CajaSidebar *(*create)(CajaSidebarProvider *provider, CajaWindowInfo *window);
};

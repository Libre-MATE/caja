...
#define CAJA_SIDEBAR(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), CAJA_TYPE_SIDEBAR, CajaSidebar))
#define CAJA_IS_SIDEBAR(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), CAJA_TYPE_SIDEBAR))
#define CAJA_SIDEBAR_GET_IFACE(obj) \
  (G_TYPE_INSTANCE_GET_INTERFACE((obj), CAJA_TYPE_SIDEBAR, CajaSidebarIface))
...
struct _CajaSidebarIface {
  ...
  void (*is_visible_changed)(CajaSidebar *sidebar, gboolean is_visible);

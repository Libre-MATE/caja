...
#define CAJA_FILE_DEFAULT_ATTRIBUTES                                        \
  "standard::*,access::*,mountable::*,time::*,unix::*,owner::*,selinux::*," \
  "thumbnail::*,id::filesystem,trash::orig-path,trash::deletion-date,"      \
  "metadata::*"

/* These are in the typical sort order. Known things come first, then
 * things where we can't know, finally things where we don't yet know.
 */
typedef enum { KNOWN, UNKNOWABLE, UNKNOWN } Knowledge;
...
void caja_file_set_directory(CajaFile *file, CajaDirectory *directory);
...
void caja_file_operation_complete(CajaFileOperation *op, GFile *result_location,
                                  GError *error);

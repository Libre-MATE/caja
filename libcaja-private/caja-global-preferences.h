...
#define CAJA_PREFERENCES_MEDIA_AUTORUN_X_CONTENT_START_APP \
  "autorun-x-content-start-app"
#define CAJA_PREFERENCES_MEDIA_AUTORUN_X_CONTENT_IGNORE \
  "autorun-x-content-ignore"
#define CAJA_PREFERENCES_MEDIA_AUTORUN_X_CONTENT_OPEN_FOLDER \
...
#define CAJA_PREFERENCES_DEFAULT_SORT_IN_REVERSE_ORDER \
...
/* Icon View */
#define CAJA_PREFERENCES_ICON_VIEW_DEFAULT_USE_TIGHTER_LAYOUT \
  "default-use-tighter-layout"

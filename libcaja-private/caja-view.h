...
#define CAJA_VIEW(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), CAJA_TYPE_VIEW, CajaView))
#define CAJA_IS_VIEW(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), CAJA_TYPE_VIEW))
#define CAJA_VIEW_GET_IFACE(obj) \
  (G_TYPE_INSTANCE_GET_INTERFACE((obj), CAJA_TYPE_VIEW, CajaViewIface))
...
struct _CajaViewIface {
  ...
  void (*load_location)(CajaView *view, const char *location_uri);
  ...
  void (*set_selection)(CajaView *view, GList *list);
  ...
  /* Scroll the view so that the file specified by the uri is at the top
     of the view */
  void (*scroll_to_file)(CajaView *view, const char *uri);
  ...
  void (*bump_zoom_level)(CajaView *view, int zoom_increment);
  void (*zoom_to_level)(CajaView *view, CajaZoomLevel level);
   ...
   * The location parameter specifies the location this popup should be
   * displayed for. If it is NULL, the currently displayed location should be
   * used. The view may display the popup synchronously, asynchronously or not
   * react to the popup request at all. */
  void (*pop_up_location_context_menu)(CajaView *view, GdkEventButton *event,
                                       const char *location);

  void (*drop_proxy_received_uris)(CajaView *view, GList *uris,
  ...
  void (*drop_proxy_received_netscape_url)(CajaView *view,
                                           ...
                                           const char *target_location,
                                           GdkDragAction action);
  void (*set_is_active)(CajaView *view, gboolean is_active);

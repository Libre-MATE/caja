...
#define CAJA_ICON_CANVAS_ITEM(obj)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), CAJA_TYPE_ICON_CANVAS_ITEM, \
                              CajaIconCanvasItem))
#define CAJA_ICON_CANVAS_ITEM_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), CAJA_TYPE_ICON_CANVAS_ITEM, \
                           CajaIconCanvasItemClass))
...
#define CAJA_ICON_CANVAS_ITEM_GET_CLASS(obj)                    \
  (G_TYPE_INSTANCE_GET_CLASS((obj), CAJA_TYPE_ICON_CANVAS_ITEM, \
                             CajaIconCanvasItemClass))

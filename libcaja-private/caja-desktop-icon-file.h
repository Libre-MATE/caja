...
#define CAJA_DESKTOP_ICON_FILE(obj)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), CAJA_TYPE_DESKTOP_ICON_FILE, \
                              CajaDesktopIconFile))
#define CAJA_DESKTOP_ICON_FILE_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), CAJA_TYPE_DESKTOP_ICON_FILE, \
...
#define CAJA_DESKTOP_ICON_FILE_GET_CLASS(obj)                    \
  (G_TYPE_INSTANCE_GET_CLASS((obj), CAJA_TYPE_DESKTOP_ICON_FILE, \
                             CajaDesktopIconFileClass))

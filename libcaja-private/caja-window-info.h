...
#define CAJA_WINDOW_INFO(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), CAJA_TYPE_WINDOW_INFO, CajaWindowInfo))
#define CAJA_IS_WINDOW_INFO(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), CAJA_TYPE_WINDOW_INFO))
#define CAJA_WINDOW_INFO_GET_IFACE(obj)                        \
  (G_TYPE_INSTANCE_GET_INTERFACE((obj), CAJA_TYPE_WINDOW_INFO, \
                                 CajaWindowInfoIface))
...
typedef void (*CajaWindowGoToCallback)(CajaWindow *window, GError *error,
                                       gpointer user_data);
...
struct _CajaWindowInfoIface {
  ...
  void (*loading_uri)(CajaWindowInfo *window, const char *uri);
  /* Emitted when the view in the window changes the selection */
  void (*selection_changed)(CajaWindowInfo *window);
  void (*title_changed)(CajaWindowInfo *window, const char *title);
  ...
  void (*report_load_underway)(CajaWindowInfo *window, CajaView *view);
  ...
  void (*report_load_complete)(CajaWindowInfo *window, CajaView *view);
  /* This can be called at any time when there has been a catastrophic failure
     of the view. It will result in the view being removed. */
  void (*report_view_failed)(CajaWindowInfo *window, CajaView *view);
  ...
  void (*push_status)(CajaWindowInfo *window, const char *status);
  char *(*get_title)(CajaWindowInfo *window);
  GList *(*get_history)(CajaWindowInfo *window);
  CajaWindowType (*get_window_type)(CajaWindowInfo *window);
  CajaWindowShowHiddenFilesMode (*get_hidden_files_mode)(
      CajaWindowInfo *window);
  void (*set_hidden_files_mode)(CajaWindowInfo *window,
                                CajaWindowShowHiddenFilesMode mode);
  CajaWindowShowBackupFilesMode (*get_backup_files_mode)(
      CajaWindowInfo *window);
  ...
  void (*view_visible)(CajaWindowInfo *window, CajaView *view);

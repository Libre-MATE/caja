 ...
 *
 * object_name   - The name of the object.  Usually what is used to represent it
 * in storage. object_pixbuf - Pixbuf for graphical display of the object.
 * object_label  - Textual label display of the object.
 */
gboolean caja_customization_data_get_next_element_for_display(
    CajaCustomizationData *data, char **object_name, GdkPixbuf **object_pixbuf,
    char **object_label);
